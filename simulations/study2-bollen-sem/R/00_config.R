# ============================================================================
# Study 2: SEM Simulation Configuration
# ============================================================================
# Bollen et al. (2014) SIM1 design: 9 indicators, 3 factors, cross-loadings
# ============================================================================
...
get_config <- function() {
  list(
    ...
    # ------- Replication -------
    n_reps      = 1000L,
    master_seed = 20260317L,

    # ------- Regularization -------
    ridge_factor = 1e-6,

    # ------- Population Covariance (Paxton et al., 2001, p. 311) -------
    sigma_pop = matrix(c(
    ...
    # ------- Model Categories -------
    # M1 = true model; others classified by relation to truth
